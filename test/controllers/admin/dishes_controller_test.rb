...
class Admin::DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_dish" do
    assert_difference('Admin::Dish.count') do
      post admin_dishes_url, params: { admin_dish: { description: @admin_dish.description, dishgroup: @admin_dish.dishgroup, name: @admin_dish.name, price: @admin_dish.price } }
    end
  ...
  test "should update admin_dish" do
    patch admin_dish_url(@admin_dish), params: { admin_dish: { description: @admin_dish.description, dishgroup: @admin_dish.dishgroup, name: @admin_dish.name, price: @admin_dish.price } }
